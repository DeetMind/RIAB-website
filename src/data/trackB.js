export const trackB = {
  ...
  summary: {
    headline: '$1.4M/yr in avoided loss achievable — 60% reduction',
    ...
    recs: [
      ...
      'Bundle 5 bridge scour protection projects for a single bond issuance — economies of scale; combined avoided loss justifies debt service.',
      'Use parametric trigger of 2.5 in/24 hr at Bethel gauge to cover the $4.2M reserve gap — aligns with Vermont\'s parametric exploration.',
    ],
  },
